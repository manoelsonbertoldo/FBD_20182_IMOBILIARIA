...
public class TelaInicial extends TelaGeral{
	...
	public TelaInicial(String titulo, int x, int y) {
		super(titulo, x, y);
		JLabel	fundo= new JLabel(new ImageIcon(getClass().getClassLoader().getResource("fundo1.png")));
		
	cadastrarLabel= new JLabel("CADASTRAR IMÓVEL");
...
mbsLabel= new JLabel("IMOBILIÁRIA");
	...
	sairLabel.setFont(grande);
		...
		add(cadastraButton).setBounds(100, 50, 100, 100);
		add(cadastrarLabel).setBounds(95, 150, 200, 50);
